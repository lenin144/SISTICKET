...
$inser=mysqli_query($con,"INSERT INTO tickets (id, created_at,client_id) VALUES ($nexts,'$created_at',$cliente); ");
    ...
    if (!isset($id) or $count!=1){
        ...
        print "<script>window.location='?view=dashboard'</script>";
    }
        ...
        <table id="example3" class="table table-bordered table-striped">
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <label style="font-weight: normal;" for="<?php echo $area['id'] ?>">
                            <?php echo $area['name'] ?>  
                        </label>
                    </td>
                </tr>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <div class="form-group col-md-12">
                    ...
                    <select class="form-control select2" id="cliente_id" name="cliente_id" onchange="return ticket_update(this.value,5);">
                        <option value="0">Selecciona Cliente</option>
                        <?php $clientes=mysqli_query($con, "select * from user where is_client=1"); ?>

    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="?view=ordendecompra"><i class="fa fa-bars"></i> Nuevo Orden de compra</a></li>
                        ...
                        <form role="form" method="post" name="add" id="add" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="bienservicio" class="form-control" id="bienservicio" placeholder="Bien o Servicio">
                                </div>
                                <div class="form-group">
            ...
            $('#save_data').attr("disabled", true);
             ...
             if($("#imagefile").val()!=""){
                ...
                // console.log('no hay archivos');
                 ...
                 $.ajax({
                        type: "POST",
                        url: "action/addordendecompra.php" + fileExist,

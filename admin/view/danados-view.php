<?php 
    ...
    $danados =mysqli_query($con, "select * from danados order by equipo asc");
...
?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>INVENTARIO DE EQUIPOS DAÑADOS - LIMA AREQUIPA</h1>
            <ol class="breadcrumb">
        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-12">
                    <a style="color:#fff; background-color:#0858D1;" class="btn btn-default pull-right" href="action/excel_danados.php"><i class='fa fa-file-excel-o'></i> Excel</a>
                    <a style="color:#fff; background-color:#0858D1;" class="btn btn-default pull-right" href="?view=nuevo_danados"><i class='fa fa-plus'></i> Nuevo</a>
                    <br><br>
                    <?php 
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a href="?view=editar_danados&id=<?php echo $item['id'] ?>"><i class="fa fa-pencil"></i> Editar</a></li>
                                                    <li><a href="action/deldanados.php?id=<?php echo $item['id'] ?>"><i class="fa fa-trash"></i> Eliminar</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>

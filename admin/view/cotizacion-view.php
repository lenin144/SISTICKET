<?php 
    ...
    $cotizacion =mysqli_query($con, "select * from cotizacion order by area asc");
...
?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>COTIZACIONES - EQUIPOS TECNOLOGICOS</h1>
            <ol class="breadcrumb">
        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-12">
                    <a style="color:#fff; background-color:#0858D1;" class="btn btn-default pull-right" href="action/excel_cotizacion.php"><i class='fa fa-file-excel-o'></i> Excel</a>
                    <a style="color:#fff; background-color:#0858D1;" class="btn btn-default pull-right" href="?view=nuevo_cotizacion"><i class='fa fa-plus'></i> Nuevo</a>
                    <br><br>
                    <?php 
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a href="?view=editar_cotizacion&id=<?php echo $item['id'] ?>"><i class="fa fa-pencil"></i> Editar</a></li>
                                                    <li><a href="action/delcotizacion.php?id=<?php echo $item['id'] ?>"><i class="fa fa-trash"></i> Eliminar</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>

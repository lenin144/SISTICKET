    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="?view=licencias"><i class="fa fa-bars"></i> Licencias</a></li>
                <li class="active">Nueva Licencia</li>
            </ol>
        </section>
                        ...
                        <form role="form" method="post" name="add" id="add" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="licencia" class="form-control" id="licencia" placeholder="Licencia">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="clave" class="form-control" id="clave" placeholder="Clave" required="">
                                </div>
                                <div class="form-group">
                                    <label for="fechareg">Fecha de registro</label>
                                    <input type="date" name="fechareg" class="form-control" id="fechareg" placeholder="Fecha de registro" >
                                </div>
                                <div class="form-group">
                                    <label for="fechaven">Fecha de vencimiento</label>
                                    <input type="date" name="fechaven" class="form-control" id="fechaven" placeholder="Fecha de vencimiento" required="">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="observacion" class="form-control" id="observacion" placeholder="Observacion" required="">
                                </div>
                                <div class="form-group">
                                    <label for="nompro">Nombre del proveedor</label>
                                    <input type="text" name="nompro" class="form-control" id="nompro" placeholder="Nombre del proveedor" required="">
                                </div>
                                <div class="form-group">
                                    <label for="numpro">Numero del proveedor</label>
                                    <input type="text" name="numpro" class="form-control" id="numpro" placeholder="Numero del proveedor" required="">
                                </div>
            ...
            $('#save_data').attr("disabled", true);
             ...
             if($("#imagefile").val()!=""){
                ...
                // console.log('no hay archivos');
                 ...
                 $.ajax({
                        type: "POST",
                        url: "action/addlicencias.php" + fileExist,

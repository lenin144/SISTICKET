...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    header("Location:?view=cotizacion");
}

$sql = mysqli_query($con, "select * from cotizacion where id=$id");
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="?view=cotizacion"><i class="fa fa-bars"></i> Datos</a></li>
                ...
                <div id="result"></div>
                    ...
                    <div class="box box-success">
                        <div class="box-header with-border">
                            <h3 class="box-title">Editar Cotizacion</h3>
                        </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                        <form role="form" method="post" name="upd" id="upd" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="numero">Numero de cotizacion</label>
...
$( "#upd" ).submit(function( event ) {
    $('#upd_data').attr("disabled", true);
     ...
     if($("#imagefile").val()!="" || $("#imagefile2").val()!="" || $("#imagefile3").val()!=""){
         ...
         $.ajax({
                type: "POST",
                url: "action/updcotizacion.php" + fileExist,

    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="?view=proveedor"><i class="fa fa-bars"></i> Equipos dañados</a></li>
                        ...
                        <form role="form" method="post" name="add" id="add" enctype="multipart/form-data">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tipo" class="form-control" id="tipo" placeholder="Tipo de documento" required="">
                                </div>
                                <div class="form-group">
                                    <label for="numero">Numero de documento</label>
                                    <input type="text" name="numero" class="form-control" id="numero" placeholder="Numero de documento" required="">
                                </div>
                                 <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="direccion" class="form-control" id="sucursal" placeholder="Direccion" required="">
                                </div>
                                <div class="form-group">
                                    <label for="nombre">Nombre de vendedores</label>
                                    <input type="text" name="nombre" class="form-control" id="nombre" placeholder="Nombre de vendedores" required="">
                                </div>
                                <div class="form-group">
            ...
            $('#save_data').attr("disabled", true);
             ...
             if($("#imagefile").val()!=""){
                ...
                // console.log('no hay archivos');
                 ...
                 $.ajax({
                        type: "POST",
                        url: "action/addproveedor.php" + fileExist,

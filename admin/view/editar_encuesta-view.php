<?php 
    ...
    $sql=mysqli_query($con, "select * from survey where idSurvey=$id");
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="?view=encuestor_design"><i class="fa fa-th-list"></i> Encuesta</a></li>

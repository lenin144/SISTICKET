                ...
                <form action="" method="get">
                    ...
                    <select name="year" onchange="this.form.submit()">
                        ...
                        ?>
                                ...
                                <a style="color:#fff; background-color:#0858D1;" class="btn btn-default pull-right" href="action/excel_mantenimiento.php?year=<?php echo $anio;?>"><i class='fa fa-file-excel-o'></i> Excel</a>
                                <br><br>
                                <?php
                                if (isset($_GET)) {
                    ...
                    <div class="box-body">
                        ...
                        <table id="example6" class="table table-bordered table-hover">
                            <thead class="table_header">
                               <tr>
                                    <th colspan="10" rowspan="2" class="text-center" style="vertical-align: middle;">Plan maestro de mantenimiento preventivo</th>
                                    <?php
                                    $cont = 0;
                                    $semana = 1;
                            ...
                            ?>
                                <tr>
                                    <td style="width: 10px !important; text-align: center;">
                                         <!-- Split button -->
                                         <div class="btn-group"  style="width: 30px">
                                            ...
                                            <ul class="dropdown-menu">
                                                <?php if($anio>substr($item['inicio'], 0, 4)){?>
                                                <li><a  href="action/hidemantenimiento.php?id=<?php echo $item['id'] ?>&year=<?php echo $anio ?>"><i class="fa fa-eye"></i> Ocultar</a></li>
                                                <?php }?>
                                                <li><a href="?view=editar_mantenimiento&id=<?php echo $item['id'] ?>"><i class="fa fa-pencil"></i> Editar</a></li>
                                                <li><a href="action/delmantenimiento.php?id=<?php echo $item['id'] ?>"><i class="fa fa-trash"></i> Eliminar</a></li>
                                            </ul>
                                        </div>
                                    </td>

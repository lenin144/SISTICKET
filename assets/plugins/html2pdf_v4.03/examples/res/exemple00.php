...
<page style="font-size: 14px">
    <span style="font-weight: bold; font-size: 18pt; color: #ca4300; font-family: Times">Bonjour, voici quelques exemples<br></span>
    <br>
    ...
    <table border="1" bordercolor="#007" bgcolor="#AAAAAA" align="center">
        <tr>
            <td border="1">
                <table style="border: solid 1px #ca4300; background: #FFFFFF; width: 100%; text-align: center">
                    <tr>

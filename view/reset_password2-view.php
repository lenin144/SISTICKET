  ...
  <body class="login-page bg-login">
    <div class="login-box">
      ...
      <div class="login-box-body">
        <?php 
            ...
            /*if (isset($_GET['invalid'])) {
                echo "<div style='background-color:#dd4b39;color:#fff' class='alert alert- alert-dismissible fade in' role='alert'>
                    <strong>Error!</strong> El Correo Electrónico ingresado no esta registrado en nuestro sistema, vuelva a intentarlo!.
                    </div>";
            }

            if (isset($_GET['ban'])) {
                echo "<div style='background-color:#f39c12;color:#fff' class='alert alert- alert-dismissible fade in' role='alert'>
                    <strong>Error!</strong> Lo sentimos la cuenta fue baneada, contacte al administrador.
                    </div>";
            }

            if (isset($_GET['success'])) {
                echo "<div style='background-color:#00a65a;color:#fff' class='alert alert- alert-dismissible fade in' role='alert'>
                    <strong>Aviso!</strong> Le hemos enviado un Correo Electrónico con los pasos para recuperar su cuenta!
                    </div>";
            }*/
        ?>
        ...
        ?>  
            <p class="login-box-msg"><i class="fa fa-user icon-title"></i> Recuperación de cuenta!</p>
            <br/>
            <form action="action/reset_password.php" method="post">
                ...
                <div class="row">
                    <div class="col-xs-12">
                    <input type="submit" class="btn btn-primary btn-lg btn-block btn-flat" name="token" value="Recuperar" />
                    </div><!-- /.col -->
                </div>
            </form>
            <br>
